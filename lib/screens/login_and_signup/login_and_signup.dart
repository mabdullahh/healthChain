...
import 'patient/fpatient_login_screen.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                RoundedButton(title: 'Login or Signup as a Patient',onTap:(){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>  const FpatientLoginScreen()),
                  );
                }),
                const SizedBox(
                  height: 20,
                ...
                RoundedButton(title: 'Login or Signup as a Doctor',onTap:(){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const FDoctorLoginScreen()),
                  );
                }),
